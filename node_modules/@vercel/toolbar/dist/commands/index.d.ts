...
declare const getInternalRegistry: (useTopWindow?: boolean) => ToolbarCommandRegistry | undefined;
type SelectHandler = () => void | boolean | Promise<void | boolean>;
type BadgeColor = 'amber' | 'blue' | 'pink' | 'purple' | 'red' | 'teal' | 'green' | 'gray';
...
type VercelToolbarCommand = InstanceType<typeof ToolbarCommand>;
